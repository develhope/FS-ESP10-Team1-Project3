...
function Login() {
  ...
  const [h1Content, setH1Content] = useState(initialMode === 'register' ? registerTitle : loginTitle);
  const [p1Content, setP1Content] = useState(initialMode === 'register' ? textoEnlace2 : textoEnlace1);
  const [aContent, setAcontent] = useState(initialMode === 'register' ? enlaceContent2 : enlaceContent1);
  useEffect(() => {
